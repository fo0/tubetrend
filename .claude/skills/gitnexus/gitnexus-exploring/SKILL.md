...
> Examples in this file use generic symbol names. GitNexus is language-agnostic — the workflow applies identically whether the indexed code is TypeScript, Python, Rust, Go, Java, C#, Ruby, PHP, or anything else GitNexus supports. File extensions and node paths in the examples are illustrative.
