...
export const InputSection: React.FC<InputSectionProps> = ({
  ...
  return (
    <div
      className="w-full bg-slate-100/50 dark:bg-slate-900/50 backdrop-blur-xl rounded-2xl p-6 md:p-8 shadow-2xl border border-slate-200 dark:border-slate-800 mb-8 relative z-40 group"
      ref={wrapperRef}
    >
      {/* Glow Effect */}
      ...
      <form
        ...
        className="flex flex-col xl:flex-row gap-5 items-end relative z-10"
      >
        ...
        <div className="flex-1 w-full space-y-2 relative">
          ...
          <div className="relative group/input">
            ...
            <input
              ...
              disabled={isLoading}
              autoComplete="off"
              title={t("input.searchHint", { placeholder: t("input.searchPlaceholder") })}
              role="combobox"
                    ...
                    <li key={sug.id} role="option" aria-selected="false">
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          {sug.handle && (
                            <p className="text-xs text-slate-500 truncate">{sug.handle}</p>
                          )}
                        </div>
                      </button>
                    </li>
