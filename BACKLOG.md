...
Entries too large for a sweep's auto-fix threshold, moved to issues so they stay schedulable. Track them there, not here.
...
| 13  | 2026-05-24 | 2026-05-30 | Security    | `node_modules/brace-expansion` (transitive)                                                                                                        | brace-expansion override raised to ^5.0.6, leaving the advisory range (GHSA-f886-m6hf-6m8v, GHSA-jxxr-4gwj-5jf2). Nested override via electron-builder chain.                |
| 14  | 2026-08-11 | 2026-08-14 | Code Smells | `ThemeProvider.tsx`, `Toast.tsx`, `VideoListSortHeader.tsx`                                                                                        | All 6 `react-refresh/only-export-components` warnings resolved. Non-component exports moved to `themeContext.ts`, `toastBus.ts` and `videoListSort.ts`; `eslint .` is clean. |
