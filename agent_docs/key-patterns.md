...
Offloaded from `CLAUDE.md` (2026-07-26) per `agent_docs/context_budget.md` ladder step 3. CLAUDE.md keeps the top-3 lookup index; the full descriptions live here.
