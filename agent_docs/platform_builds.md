...
Offloaded from `CLAUDE.md` (2026-07-26, extended 2026-08-14) per `agent_docs/context_budget.md` ladder step 8 / 10. CLAUDE.md keeps the load-bearing development notes (the two toolchain traps under _Coding Conventions_) and a one-line stack summary; the full tech-stack table and the per-platform detail live here.
