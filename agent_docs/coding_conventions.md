...
Offloaded from `CLAUDE.md` (2026-07-26) per `agent_docs/context_budget.md` ladder steps 7 + 9. CLAUDE.md keeps at most six repo-wide bullets; the full set, the path-alias table and the project-specific architecture notes live here.
